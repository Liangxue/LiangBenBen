...
#import "LBBLiveChatViewController.h"

@interface LBBLiveChatViewController ()
...
@implementation LBBLiveChatViewController
...
- (IBAction)gifts:(UIButton *)sender {
...
- (void)setLive:(LBBLive *)live{
    ...
    [self.headImageView downloadImage:live.creator.portrait placeholder:nil];
...
- (void)initTimer {
    ...
    dispatch_source_set_event_handler(self.timer, ^{
        ...
        [self showMoreLoveAnimateFromView:self.gifts addToView:self.view];
    });
