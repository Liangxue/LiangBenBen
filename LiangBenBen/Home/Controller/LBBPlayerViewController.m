...
@interface LBBPlayerViewController ()
...
@property (nonatomic,strong) LBBLiveChatViewController *chatVC;

@end

@implementation LBBPlayerViewController

- (LBBLiveChatViewController *)chatVC{
    
    if (!_chatVC) {
        
        _chatVC = [[LBBLiveChatViewController alloc]init];
